  ...
  return (
    <div className="max-w-4xl mx-auto p-6 sm:p-8 md:p-10 lg:p-12 bg-[#a4a1a1] text-gray-800">
      ...
      <p className="text-sm sm:text-base mb-6">
        ...
        contact us at{" "}
        <a
          href="mailto:hamednourzaie1@gmail.com"
          className="text-blue-600 hover:underline"
        >
      ...
      <ol className="list-decimal list-inside mb-6 text-sm sm:text-base">
      ...
      <p className="text-sm sm:text-base mb-6">
        ...
        following functions: AI deployment.
      </p>
      <p className="text-sm sm:text-base mb-6">
        <strong>How We Process Your Data Using AI.</strong> All personal
        information processed using our AI Products is handled in line with our
        Privacy Notice and our agreement with third parties.
      </p>
      ...
      <p className="text-sm sm:text-base mb-6">
        ...
        jurisdiction, nor do we knowingly sell such personal information. If we
        learn that personal information from users less than 18 years of age or
        the equivalent age as specified by law in your jurisdiction has been
      ...
      <ul className="list-disc list-inside mb-6 text-sm sm:text-base">
        ...
        <li>Right to limit use and disclosure of sensitive personal data</li>
        <li>
      ...
      <p className="text-sm sm:text-base mb-6">
        <strong>Swiss Representative</strong>
        <br />
        __________
        <br />
        Okstigen 2<br />
