...
export const FooterSection = () => {
  return (
    <footer id="footer" className="container font-kalameh font-semibold py-24 sm:py-32 ">
      <div className="p-10 bg-card  rounded-2xl  border-[1px] border-orange-800 shadow-xl shadow-orange-400/10">
        <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-x-12 gap-y-8">
          <div className="col-span-full xl:col-span-2">
            <Link href="#" className="flex font-sans font-bold items-center">
              <ChevronsDownIcon className="w-9 h-9 mr-2 bg-gradient-to-tr from-primary via-primary/70 to-primary rounded-lg border " />
